...
export const metadata: Metadata = generateDefaultMetadata(
  '서비스 이용약관',
  '꼬순내 서비스 이용 조건, 회원의 권리와 의무 및 책임 범위를 안내합니다.',
...
const sections = [
  {
    title: '1. 목적',
    body: [
      '본 약관은 꼬순내가 제공하는 유기동물 입양 공고와 AI 검색 등 관련 서비스의 이용 조건과 절차, 회사와 이용자의 권리·의무 및 책임 사항을 정하는 것을 목적으로 합니다.',
    ],
  },
  {
    title: '2. 서비스 내용',
    body: [
      '꼬순내는 유기동물 공고 조회, 위치 기반 추천, AI 유사 동물 검색, 회원 프로필과 동물 찜 기능 등을 제공합니다.',
  ...
  },
  {
    ...
    body: [
      '꼬순내는 운영상 또는 기술상 필요에 따라 서비스의 전부 또는 일부를 변경하거나 중단할 수 있습니다.',
  ...
  },
  {
    title: '6. 지식재산권',
    body: [
      '꼬순내 서비스, 디자인, 상호, 로고 및 운영자가 작성한 콘텐츠에 대한 권리는 관련 법령이 허용하는 범위에서 꼬순내 또는 정당한 권리자에게 귀속됩니다.',
    ],
  },
  {
    title: '7. 책임의 제한',
    body: [
      '꼬순내는 천재지변, 통신 장애, 제3자 서비스 장애, 이용자 귀책 사유로 발생한 손해에 대해 책임을 지지 않습니다.',
      '꼬순내는 이용자 또는 보호소가 게시한 정보의 정확성, 완전성, 최신성을 보증하지 않으며, 입양이나 거래 판단은 이용자 본인의 책임으로 이루어져야 합니다.',
    ],
  },
  {
    title: '8. 이용 제한 및 해지',
    body: [
      '이용자가 본 약관을 위반하거나 서비스 운영을 방해하는 경우, 꼬순내는 경고, 계정 일시 정지, 영구 이용 제한 등의 조치를 할 수 있습니다.',
