...
const sections = [
  {
    title: '1. 총칙',
    body: [
      '포유테일은 유기동물 입양 공고 조회와 AI 검색 제공을 위해 필요한 범위에서만 개인정보를 처리합니다.',
  ...
  },
  {
    ...
    body: [
      ...
      '서비스 운영을 위해 Firebase Authentication, Cloud Firestore, Google Analytics, Google AdSense 등 외부 서비스를 사용할 수 있으며, 이 과정에서 필요한 범위의 데이터가 각 서비스 사업자에게 처리 위탁 또는 전송될 수 있습니다.',
    ],
  },
  {
