...
const sections = [
  {
    title: '1. 총칙',
    body: [
      'matchichi는 유기동물 입양 공고 조회와 AI 검색 제공을 위해 필요한 범위에서만 개인정보를 처리합니다.',
      '본 방침은 matchichi 웹사이트와 그에 부속하는 서비스 전반에 적용되며, 관련 법령 또는 서비스 변경에 따라 수정될 수 있습니다.',
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      'matchichi는 원칙적으로 이용자의 개인정보를 외부에 판매하거나 법적 근거 없이 제3자에게 제공하지 않습니다.',
  ...
  },
  {
    title: '8. 안전성 확보 조치',
    body: [
      'matchichi는 접근 권한 관리, 인증 체계 운영, 전송 구간 보호, 최소 권한 원칙 적용 등 합리적인 보호 조치를 시행합니다.',
  ...
  },
  {
    title: '9. 아동의 개인정보',
    body: [
      'matchichi는 원칙적으로 법정대리인의 동의가 필요한 연령대의 아동을 대상으로 회원가입을 유도하지 않습니다.',
...
const englishSections = [
  { title: '1. Overview', body: ['matchichi processes personal information only as necessary to provide shelter-animal listings and AI search.', 'This Policy applies to the matchichi website and related services and may be updated following changes in law or the service.'] },
  ...
  { title: '5. Third parties and processors', body: ['matchichi does not sell personal information or disclose it to third parties without a lawful basis.', 'We may use services such as Supabase Authentication, Supabase Database, Google Analytics, and Google AdSense. Necessary data may be processed by or transferred to those providers.'] },
  ...
  { title: '8. Security', body: ['matchichi applies reasonable safeguards including access controls, authentication, transport protection, and least-privilege access.', 'No internet service can guarantee complete security, so users should also follow basic security practices.'] },
  { title: '9. Children', body: ['matchichi does not intentionally encourage registration by children who require consent from a legal guardian.', 'If such information is identified, it may be promptly deleted or otherwise handled as required.'] },
...
export default function PrivacyPage() {
  return (
    <LegalDocumentPage
      ...
      title="개인정보처리방침"
      description="matchichi 서비스 운영 과정에서 어떤 정보가 왜 수집되고, 어떻게 보관·이용되는지 안내합니다."
      effectiveDate="2026년 4월 27일"
      sections={sections}
      english={{
        title: 'Privacy Policy',
        description: 'Learn what information matchichi collects, why it is used, and how it is stored and protected.',
