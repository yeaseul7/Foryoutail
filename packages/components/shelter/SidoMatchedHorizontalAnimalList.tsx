...
import RegionalNearbyAnimalCard from '@/packages/components/shelter/RegionalNearbyAnimalCard';
import RegionalNearbyAnimalCardSkeleton from '@/packages/components/skeleton/RegionalNearbyAnimalCardSkeleton';
import { DISPLAY_COUNT } from '@/packages/components/shelter/horizontalAnimalCarousel';
